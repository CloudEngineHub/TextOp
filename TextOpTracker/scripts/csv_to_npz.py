...
parser.add_argument(
    ...
    type=int,
    metavar=("START", "END"),
    help=("frame range: START END (both inclusive). The frame index starts from 1. If not provided, all frames will be loaded."),
)
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene, joint_names: list[str], MotionLoaderCls=MotionLoader):
    ...
    while simulation_app.is_running():
        ...
        if reset_flag and not file_saved:
            ...
            save_path = f"./artifacts/{args_cli.output_name}/motion.npz"
            import os
            ...
            #             run = wandb.init(entity="yochi", project="csv_to_npz", name=COLLECTION)
            #
